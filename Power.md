...
There are 5 types of batteries you're likely to encounter in the wild:
 ...
 Alkaline [non-rechargeable] (typical 1.5V AA AAA C D 9V etc)
   ...
   Name brand 9V batteries often contain 6 AAAA cells in serious, they can be used individually if need be.
